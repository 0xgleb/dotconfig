...
function moveLogicalVertical(ctx: VisualModeContext, direction: -1 | 1, count: number): void {
  const target = logicalVerticalPosition(ctx.getText().split("\n"), ctx.getCursor(), direction, count);
