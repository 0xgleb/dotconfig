---
name: worktree
description: Use `/worktree` only to create, inspect, verify, or repair isolated git worktrees and their submodules; do not use it for ordinary branch, PR, Graphite, or GitButler stack navigation.
user-invocable: true
allowed-tools:
  - "Bash(git *)"
  - "Bash(gt init *)"
