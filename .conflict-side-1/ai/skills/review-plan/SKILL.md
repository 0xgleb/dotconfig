...
name: review-plan
user-invocable: true
description: Use when a concrete implementation plan already exists and needs sequencing, dependency, vertical-slice, and validation review before execution; do not use for vague intent shaping, architecture design, ADR recording, or code review.
---
