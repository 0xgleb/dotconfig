...
description: Auto-run when a review or audit touches Rust (.rs or Cargo) code; find ownership and borrowing anti-patterns, missed standard-library idioms, unsafe/error/type-modeling issues, and non-idiomatic constructs, but do not duplicate financial, security, or domain-specific inspectors.
