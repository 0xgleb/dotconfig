...
export interface ControlPlaneConfig {
  ...
  readonly bridgeDatabasePath: string
...
export const parseControlPlaneConfig = (
  ...
  return Effect.succeed({
    ...
    bridgeDatabasePath: remoteBridgeDatabasePath(stateRoot, home),
...
export const runControlPlane = (
  ...
  const bridgeStore = makeRemoteBridgeStore(config.bridgeDatabasePath)
