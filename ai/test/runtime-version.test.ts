...
test("fleet diagnostics expose current behavior-bearing component versions", () => {
  assert.match(read("../pi/extensions/shared/runtime-version.ts"), /MANAGED_CONFIG_GENERATION = "2026\.07\.23\.110"/);
  ...
  assert.match(read("../pi/extensions/classified-workflows/index.ts"), /classified-workflows", "2026\.07\.23\.76"/);
  ...
  assert.match(read("../pi/extensions/disk-pressure/index.ts"), /resource-pressure", "2026\.07\.23\.6"/);
