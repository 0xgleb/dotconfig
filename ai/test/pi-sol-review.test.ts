...
const skill = readFileSync(new URL("../skills/pi-delegation/SKILL.md", import.meta.url), "utf8");
...
test("Claude Code receives a classified read-only Codex Sol reviewer wrapper", () => {
  ...
  assert.match(home, /--extension "\$HOME\/\.config\/ai\/pi\/extensions\/classified-workflows\/index\.ts"/);
