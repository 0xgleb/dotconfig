...
allowed-tools:
  ...
  - Edit
description: >-
  Use when a vague idea, issue, or potentially irreversible or multi-file
  change needs intent shaping before planning or an ADR; trigger on "shape
  this idea", "explore the design space", "stress-test this direction",
  "lock intent", or "interview me" regardless of implementation language,
  and never use it to plan or write code.
---
