...
const userStateRoot = (xdgStateHome: string | undefined, home: string): string =>
  xdgStateHome?.trim() || join(home, ".local", "state");

export const remoteBridgeStateRoot = (xdgStateHome: string | undefined, home: string): string =>
  join(userStateRoot(xdgStateHome, home), "pi", "remote-control");
 ...
 */
export const pieceOfPiStatePath = (xdgStateHome: string | undefined, home: string): string =>
