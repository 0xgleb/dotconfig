...
const AUTOMATIC_REPOSITORIES: Readonly<
  Partial<Record<ReviewDutyProfile, readonly string[]>>
> = {
  "dataclique-review": ["dataclique/yielduck", "0xgleb/dotconfig"],
...
export const repositoryAutomaticForProfile = (
  profile: ReviewDutyProfile,
  repository: string,
): boolean => AUTOMATIC_REPOSITORIES[profile]?.includes(repository) ?? false
